...
<div class="container-fluid">
  <img src="resources/images/newlogo.png" width="70" height="70" class="d-inline-block align-top" alt="">
  <a class="navbar-brand" href="/"><h3 class="text-color"><i>Online Food Plaza</i></h3></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91-7507288764<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">onlinefoodplaza@gmail.com
            </b>
        </p>
        </div>
      </div>
